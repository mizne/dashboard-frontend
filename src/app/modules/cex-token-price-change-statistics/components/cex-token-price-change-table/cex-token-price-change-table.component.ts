...
import { CexTokenVolumeRankingStatistics, CexTokenVolumeRankingStatisticsService, KlineIntervalService, AVAILABLE_CEX_TOKEN_VOLUME_RANKING_IN_DAYS_LIST, CexTokenPriceChange, CexTokenPriceChangeService } from 'src/app/shared';
import { removeEmpty } from 'src/app/utils';

@Component({
  selector: 'cex-token-price-change-table',
  templateUrl: './cex-token-price-change-table.component.html'
})
export class CexTokenPriceChangeTableComponent implements OnInit {
