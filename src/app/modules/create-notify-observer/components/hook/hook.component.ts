...
@Component({
  selector: 'app-create-hook',
  templateUrl: './hook.component.html',
})
export class CreateHookComponent implements OnInit, FormItemInterface {
...
`
  ...
  tester() {
    if (!this.data.value.hookScript) {
      this.notification.error(`hookScript required`, `hookScript required`)
      return
    }
  ...
  private loadHookTypes() {
    this.notifyObserverService.queryHookTypes()
      .subscribe(items => {
        this.hookTypes = items
      })
  }
}
