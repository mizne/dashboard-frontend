export enum NotifyObserverTypes {
  ...
  VITALIK_BLOG = 'VITALIK_BLOG',
  CONSENSYS_BLOG = 'CONSENSYS_BLOG',
  POLYGON_BLOG = 'POLYGON_BLOG',
  PARADIGM_BLOG = 'PARADIGM_BLOG',
  JUMPCRYPTO_BLOG = 'JUMPCRYPTO_BLOG',
  A16ZCRYPTO_BLOG = 'A16ZCRYPTO_BLOG',
  SOQUEST = 'SOQUEST',
  SUBSTACK = 'SUBSTACK',
